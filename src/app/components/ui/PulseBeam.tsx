...
export const PulseBeams = ({
  ...
  return (
    <div className="flex flex-col h-screen w-screen relative items-center justify-center antialiased overflow-hidden">
      <button className="bg-slate-800 w-[320px] z-40 h-[120px] no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6 text-white inline-block">
        ...
        <div
          onClick={onClick}
          className="relative flex justify-center w-[320px] text-center space-x-2 h-[120px]  items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 "
        >
          <span className="text-4xl text-base inline-block bg-clip-text text-transparent bg-gradient-to-r from-neutral-300 via-neutral-600 to-neutral-300">
            {label}
          </span>
        </div>
      </button>
